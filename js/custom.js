...
$(document).ready(function () {
	...
	// Google Map //
	$('#map_canvas').gmap({
		'center': new google.maps.LatLng(33.793399, -84.39622), // Change this to your desired latitude and longitude
		'zoom': 11,
	...
	$('#map_canvas').gmap().bind('init', function () {
		$('#map_canvas').gmap('addMarker', {
			'id': 'marker-1',
			'position': '33.793399, -84.39622',
			'bounds': false,
			'icon': image
		}).click(function () {
			$('#map_canvas').gmap('openInfoWindow', {
				'content': '<h4>Polygon</h4><p>264 19th Street NW Suite 2250. Atlanta, GA 30363 <br><a href="http://polygonatl.com">polygonatl.com</a></p>'
			}, this);
		});
	});
